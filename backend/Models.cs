...
namespace Backend.Models
{
    ...
    public record UpdateCampaignRequest(string? Name, int? ObjectiveId, string? Brief, string? StylePreset, string? AspectRatio, decimal? TotalBudget, decimal? DailyBudget, string? BidStrategy, string? Status, string[]? Platforms, DateTime? StartDate, DateTime? EndDate);
    ...
    public record FacebookDeployRequest(FacebookCampaignPayload campaign, FacebookAdSetPayload adSet, FacebookCreativePayload creative, string assetId);
